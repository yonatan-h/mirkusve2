...
function submitAnswerDoGet(event) {
	try {
		...
		const isAnswered = !answerCellsEmpty(question, name);
		return outPutJSON({ isAnswered });
	} catch (error) {
		Logger.log(error);
...
function submitAnswerDoPost(event) {
	try {
