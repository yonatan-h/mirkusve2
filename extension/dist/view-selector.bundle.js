...
/***/ "./node_modules/css-loader/dist/cjs.js!./src/answer-submit/answer-submit.css":
/*!***********************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./src/answer-submit/answer-submit.css ***!
  \***********************************************************************************/
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".m-hidden {\n\tdisplay: none;\n}\n.m-timer button {\n\tpadding: 0rem;\n\tfont-size: 1.2rem;\n}\n.m-timer {\n\tmargin: 0;\n\tposition: fixed;\n\tleft: 20%;\n\ttop: 2%;\n\tz-index: 99;\n\n\tbackdrop-filter: blur(10px);\n\tborder-right: 5px solid rgb(248, 159, 27);\n\tbackground-color: rgba(235, 234, 234, 0.8);\n\n\tcolor: black;\n\tmin-width: 13rem;\n}\n", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/***/ "./src/answer-submit/answer-submit.html":
/*!**********************************************!*\
  !*** ./src/answer-submit/answer-submit.html ***!
  \**********************************************/
...
/***/ "./src/answer-submit/answer-submit.css":
/*!*********************************************!*\
  !*** ./src/answer-submit/answer-submit.css ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_answer_submit_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../node_modules/css-loader/dist/cjs.js!./answer-submit.css */ "./node_modules/css-loader/dist/cjs.js!./src/answer-submit/answer-submit.css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_answer_submit_css__WEBPACK_IMPORTED_MODULE_6__["default"], options);




       /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_css_loader_dist_cjs_js_answer_submit_css__WEBPACK_IMPORTED_MODULE_6__["default"] && _node_modules_css_loader_dist_cjs_js_answer_submit_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals ? _node_modules_css_loader_dist_cjs_js_answer_submit_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals : undefined);
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! !../../node_modules/style-loader/dist/runtime/styleTagTransform.js */ "./node_modules/style-loader/dist/runtime/styleTagTransform.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_timer_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../node_modules/css-loader/dist/cjs.js!./timer.css */ "./node_modules/css-loader/dist/cjs.js!./src/timer/timer.css");
...
/***/ "./src/answer-submit/fill-inputs.js":
/*!******************************************!*\
  !*** ./src/answer-submit/fill-inputs.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/answer-submit/send-answer.js":
/*!******************************************!*\
  !*** ./src/answer-submit/send-answer.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _lib_excess_slash_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../lib/excess-slash.js */ "./src/lib/excess-slash.js");
/* harmony import */ var _keys_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../keys.js */ "./src/keys.js");
/* harmony import */ var _lib_custom_errors_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../lib/custom-errors.js */ "./src/lib/custom-errors.js");
...
function extractKeyValues(form) {
	...
	if (!keyValues["folderPath"]) {
		...
		throw new _lib_custom_errors_js__WEBPACK_IMPORTED_MODULE_3__.CustomError(message);
	}

	for (const key in keyValues) {
		if (!keyValues[key]) throw new _lib_custom_errors_js__WEBPACK_IMPORTED_MODULE_3__.EmptyInputError(key);
	}
	return keyValues;
}
...
async function errorIfAlreadyAnswered(questionName) {
	...
	let url = _keys_js__WEBPACK_IMPORTED_MODULE_2__.submitAnswerUrl;
	url += `&name=${name}&question=${questionName}&group=${group}`;
	url = (0,_lib_excess_slash_js__WEBPACK_IMPORTED_MODULE_1__["default"])(url);

	const { isAnswered } = await (0,_lib_robust_fetch_js__WEBPACK_IMPORTED_MODULE_0__["default"])(url);
	if (isAnswered) {
...
async function uploadFileResponse(filePath, file) {
	...
	fileUrl = (0,_lib_excess_slash_js__WEBPACK_IMPORTED_MODULE_1__["default"])(fileUrl);
...
function errorIfBadStatus(response) {
	if (!response.ok) {
		throw new _lib_custom_errors_js__WEBPACK_IMPORTED_MODULE_3__.BadStatusError(response);
	}
}
...
async function submitToSheets({
	...
	const data = await (0,_lib_robust_fetch_js__WEBPACK_IMPORTED_MODULE_0__["default"])(url, { method: "POST" });

	if (data.error) {
		const { descriptionAndSolution, errorAsString = "" } = data;
		if (errorAsString) {
			throw new _lib_custom_errors_js__WEBPACK_IMPORTED_MODULE_3__.CustomError(descriptionAndSolution, errorAsString);
		} else {
			throw new _lib_custom_errors_js__WEBPACK_IMPORTED_MODULE_3__.CustomError(descriptionAndSolution);
		}
	}
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getSelectedDiv": () => (/* binding */ getSelectedDiv),
/* harmony export */   "getSubmissionSpans": () => (/* binding */ getSubmissionSpans),
/* harmony export */   "selectedWasAccepted": () => (/* binding */ selectedWasAccepted)
/* harmony export */ });
...
(() => {
/*!********************************************!*\
  !*** ./src/view-selector/view-selector.js ***!
  \********************************************/
__webpack_require__.r(__webpack_exports__);
...
/******/ })()
;
//# sourceMappingURL=view-selector.bundle.js.map